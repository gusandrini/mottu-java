...
public interface MotoRepository extends JpaRepository<Moto, Long>{
	...
	List<Moto> buscarPorSituacaoOrdenadoPorModelo(String situacao);
    ...
    @Query("SELECT m.nm_placa AS nmPlaca, m.nm_modelo AS nmModelo, m.st_moto AS stMoto " +
    	       ...
    	       "ORDER BY m.nm_modelo ASC")
    	List<MotoProjection> buscarMotosPorNomeDaFilialOrdenadoPorModelo(String nomeFilial);
}
